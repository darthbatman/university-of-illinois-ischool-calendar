...
var HelpMessage = "Here are some things you can say: Is there an event today? Is there an event on the 15th of November? What are the events next week? Are there any events tomorrow?  What would you like to know?";
                ...
                if (eventList.length > 0) {
                    ...
                    if (eventDate.startDate && eventDate.endDate) {
                        ...
                        if (relevantEvents.length > 0) {
                            ...
                            if (haveEventsRepromt.indexOf("\n") != -1){
                                haveEventsRepromt = haveEventsRepromt.split("\n")[0];
                            }
                            if (cardTitle.indexOf("\n") != -1){
                                cardTitle = cardTitle.split("\n")[0];
                            }
                            if (cardContent.indexOf("\n") != -1){
